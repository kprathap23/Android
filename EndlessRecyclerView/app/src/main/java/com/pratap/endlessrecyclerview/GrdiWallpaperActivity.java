 ...
 */
public class GrdiWallpaperActivity extends AppCompatActivity {
    ...
    private GrdiWallPaperDataAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new GrdiWallPaperDataAdapter(wallpaperImagesList, mRecyclerView);

        // set the adapter object to the Recyclerview
        mRecyclerView.setAdapter(mAdapter);
        // mRecyclerView.addItemDecoration(new ItemDecorationAlbumColumns(getResources().getDimensionPixelSize(R.dimen.photos_list_spacing), getResources().getInteger(R.integer.photo_list_preview_columns)));
        ...
        gLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                switch (mAdapter.getItemViewType(position)) {
                    case GrdiWallPaperDataAdapter.VIEW_ITEM:
                        return 1;
                    case GrdiWallPaperDataAdapter.VIEW_PROG:
