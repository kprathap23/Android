...
public class GrdiWallPaperDataAdapter extends RecyclerView.Adapter {
    ...
    public GrdiWallPaperDataAdapter(List<WallPaper> imagesList1, RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.wallgrid_item, parent, false);
